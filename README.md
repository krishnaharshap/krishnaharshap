...
## **Experience Focus**
Most recently worked on insurance policy platforms at Sovereign General Insurance, where I owned end-to-end QA delivery across releases. This included test planning, automation, API validation, and close collaboration with developers, product owners, and business stakeholders to align testing with real-world workflows and reduce production risk.
